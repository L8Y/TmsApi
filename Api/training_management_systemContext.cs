...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-DNK5RHH\\SQLEXPRESS;Initial Catalog=training_management_system;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailId, "UQ__employee__3FEF87672EF6F8F6")
                    .IsUnique();
            ...
            modelBuilder.Entity<Hr>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailId, "UQ__hr__3FEF8767D2B6F5EE")
                    .IsUnique();
            ...
            modelBuilder.Entity<Manager>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailId, "UQ__manager__3FEF87674838045C")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Hr)
                    ...
                    .HasConstraintName("FK__manager__hr_id__3E52440B");
            });
            ...
            modelBuilder.Entity<TrainingEnrolled>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK__training___emplo__70DDC3D8");

                entity.HasOne(d => d.Training)
                    .WithMany(p => p.TrainingEnrolleds)
                    .HasForeignKey(d => d.TrainingId)
                    .HasConstraintName("FK__training___train__6FE99F9F");
            });
            ...
            modelBuilder.Entity<TrainingRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.EmployeeEmailNavigation)
                    ...
                    .HasConstraintName("FK__training___emplo__619B8048");
